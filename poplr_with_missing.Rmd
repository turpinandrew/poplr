...
PoPLR(matrix(c(
    40, 30, 30, 30, 30,
    40, NA, 20, 15, NA), nrow = 2, byrow = TRUE), w = FALSE)

PoPLR(matrix(c(
    40, 30, 30, 30, 30,
    40, NA, 20, NA, 10), nrow = 2, byrow = TRUE), w = FALSE)
...
|  Run                             | squish NAs   | diff perms    |
|:---------------------------------|-------------:|--------------:|
| PoPLR(b[z, ], w = FALSE)         |  0.01680672  |   0.06666667  |
| PoPLR(b[zz, ], w = FALSE)        |  0.3319328   |   0.3375      |
| PoPLR(b[53:56, ], w = FALSE)     |  0.1134454   |   0.1041667   |
| PoPLR(b[53:56, 2:5], w = FALSE)  |  0.06521739  |   0.1041667   |
| PoPLR( matrix(c(                 |              |             |
|  &#12;  30, 30, 30, 30, 30,          |               |               |
...
| PoPLR( matrix(c(                     |               |               |
|  &#12;   30, 30, 30+10, 30, 30,      |               |               |
|  &#12;   NA, NA, 20+10, 15, 10), ...)| 0.01260504    | 0.008333333   |
|PoPLR(matrix(c(                       |               |               |                 
|  &#12;  30, 30, 30+10, 30, 30,       |  | | 
|  &#12;  NA, 25, 20+10, 15, 10), ...) |  | |